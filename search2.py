...
def main():
    download_youtube_videos(youtube_directory, playlist_link)
    create_directory(transcription_directory)
    transcribe_videos(transcription_directory, youtube_directory)
